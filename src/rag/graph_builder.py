...
def general_llm(state: State):
    ...
    print("General LLM response generated")
...
def grade(state: State):
    ...
    print(f"Grading result score: {result.binary_score}")
...
def rewrite_query(state: State):
    ...
    print(f"Query rewritten successfully (attempt {retry_count})")
...
def web_search(state: State):
    ...
    print(f"Retrieved {len(contents)} web search results from Tavily")
